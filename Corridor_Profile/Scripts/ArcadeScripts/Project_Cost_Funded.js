...
if (HasKey($dataSources, fullLayerID)) {
    ...
    if (Count(selectedFeatures) > 0) {
      ...
      // Try to get Project_Cost_Funded directly first
      var value = feature["Project_Cost_Funded"];
      ...
      // Display the Project_Cost_Funded for the selected feature
      if (!IsEmpty(value)) {
      ...
      // CASE B: Nothing selected -> Sum total Project_Cost_Funded
      var allFeatures = fullSource.layer;
      var totalValue = Sum(allFeatures, "Project_Cost_Funded");
