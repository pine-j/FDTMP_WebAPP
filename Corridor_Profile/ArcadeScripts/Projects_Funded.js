...
if (HasKey($dataSources, fullLayerID)) {
    ...
    if (Count(selectedFeatures) > 0) {
      ...
      // Try to get Projects_Funded directly first
      var value = feature["Projects_Funded"];
      ...
      // Display the Projects_Funded for the selected feature
      if (!IsEmpty(value)) {
      ...
      // CASE B: Nothing selected -> Sum total Projects_Funded
      var allFeatures = fullSource.layer;
      var totalValue = Sum(allFeatures, "Projects_Funded");
