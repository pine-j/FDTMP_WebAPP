...
if (HasKey($dataSources, fullLayerID)) {
    ...
    if (Count(selectedFeatures) > 0) {
      ...
      // Try to get Project_Cost_Unfunded directly first
      var value = feature["Project_Cost_Unfunded"];
      ...
      // Display the Project_Cost_Unfunded for the selected feature
      if (!IsEmpty(value)) {
      ...
      // CASE B: Nothing selected -> Sum total Project_Cost_Unfunded
      var allFeatures = fullSource.layer;
      var totalValue = Sum(allFeatures, "Project_Cost_Unfunded");
